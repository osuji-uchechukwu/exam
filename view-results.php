...
<head>
    ...
    <!-- Title Page-->
    <title>View Test Results - Goglow Dashboard</title>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">View Test Results</h3>
...
/****** end build pagination links ******/
        ?>
                                ...
                                <div class="table-responsive table-responsive-data2" style="overflow:scroll; overflow-x:auto; height: 370px;">
                                  ...
                                  <th><i class="fa fa-bookmark"></i> Exam ID</th>
                                  <th><i class="fa fa-bookmark"></i> Exam Code Name</th>
                                  <th><i class="fa fa-bookmark"></i> Course</th>
                                  <th><i class="fa fa-bookmark"></i> Score</th>
                                  <th><i class="fa fa-bookmark"></i> Exam Date</th>
                ...
                $result = mysql_query("SELECT * FROM Results WHERE AccountID='$accountid' ORDER BY ResultsID DESC LIMIT $offset, $rowsperpage");
                ...
                $exid = $row['ExamID'];
                                           ...
                                           echo ' <tr class="tr-shadow">
                                                ...
                                                <td>
                                                  ...
                                                  echo '<a href="print-test-result.php?exid='.$exid.'">';
                                                  echo '<button type="submit" class="btn btn-success btn-sm" id="submit" name="submit" value="PRINT RESULT">
                                                            <i class="fa fa-dot-circle-o btn-success"></i> PRINT RESULT
                                                        </button></a>';
